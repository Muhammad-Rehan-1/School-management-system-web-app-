...
export default function EditStudentModal({ student, onClose }){
  ...
  async function submit(e){
    ...
    try{
      ...
      const data = { ...form, admissionFees: admission, monthlyFees: monthly }
      await updateStudent(student.id, data, (p)=> setUploadProgress(p))
      onClose()
    }catch(err){
    ...
    <div className="modal-backdrop">
      <div className="modal">
        ...
        <form className="modal-body" onSubmit={submit}>
          ...
          <div className="field">
            <label>Update B-Form (optional)</label>
